...
const firebaseConfig = {
  apiKey: "AIzaSyCTLxrqojZcwP1Jj8_gTlv8Pk3B8kt2nzg",
  authDomain: "wawa-countdown.firebaseapp.com",
  projectId: "wawa-countdown",
  storageBucket: "wawa-countdown.appspot.com",
  messagingSenderId: "862791941031",
  appId: "1:862791941031:web:846a98361bc0fcf08f9482",
  measurementId: "G-M317J9CX0D"
};
...
function saveInstructorData() {
  ...
  const preferredName = document.getElementsByName('preferred-name1')[0].value;
  const email = document.getElementsByName('email1')[0].value;
  const top3_destinations = document.getElementsByName('top3_destinations1')[0].value;
  const teach_professionally = document.getElementsByName('teach-professionally')[0].value;
  ...
  const formData = {
      ...
      email: email,
      top3_destinations: top3_destinations,
      teach_professionally: teach_professionally 
  };
...
document.getElementById('instructor_email-form').addEventListener('submit', saveInstructorData);
...
function saveTravellerData() {
  ...
  const preferredName = document.getElementsByName('preferred-name')[0].value;
  const email = document.getElementsByName('email')[0].value;
  const top3_destinations = document.getElementsByName('top3_destinations')[0].value;
  const travel_who = document.getElementsByName('travel-who')[0].value;
...
var x = setInterval(function() {
  ...
  document.getElementById("js-clock-days").innerHTML = days;
  document.getElementById("js-clock-hours").innerHTML = hours;
  document.getElementById("js-clock-minutes").innerHTML = minutes;
  document.getElementById("js-clock-seconds").innerHTML = seconds;
